...
package com.microrisc.simply.demos.automation.mqtt;

import com.microrisc.simply.demos.automation.AppStd;
import com.microrisc.simply.demos.automation.dpa.DPA_Request;
import com.microrisc.simply.demos.automation.dpa.DPA_Result;
import com.microrisc.simply.demos.automation.dpa.ResponseData;
import com.microrisc.simply.demos.automation.web.WebRequestParser;
    ...
    public void messageArrived(String topic, MqttMessage message) throws MqttException {
        ...
        try {
            ...
            if(dpaRequest.getDpa().equalsIgnoreCase("req")) {
                result = AppStd.sendWebRequestToDpaNetwork(dpaRequest, topic);
            }
