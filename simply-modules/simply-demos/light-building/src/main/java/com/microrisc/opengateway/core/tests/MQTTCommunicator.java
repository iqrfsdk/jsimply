...
public class MQTTCommunicator implements MqttCallback {
     ...
     * @param netType type of iqrf network 
     * @throws MqttException
     */
    public MQTTCommunicator(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password, String certFile, String netType) throws MqttException {
