    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (result == null) {            
            ...
            if ( procState == ERROR ) {
                ...
                printMessageAndExit("Reset failed: " + error);
            } else {
                printMessageAndExit("Reset hasn't been processed yet: " + procState);
            }
        }
        System.out.println("Module has been reseted");
