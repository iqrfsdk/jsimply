 ...
 */
package com.microrisc.simply.iqrf.dpa.v22x.protronix;
...
/**
 * Temperature Sensor Device Interface.
 * <p>
 * IMPORTANT NOTE: <br>
 ...
 */
@DeviceInterface
public interface Temperature_Sensor 
extends DPA_StandardServices, GenericAsyncCallable, MethodIdTransformer {
    ...
    /**
     * Sends method call request for getting value of temperature.
     ...
     * @return CO2 concetration [in Celsius degrees] <br>
