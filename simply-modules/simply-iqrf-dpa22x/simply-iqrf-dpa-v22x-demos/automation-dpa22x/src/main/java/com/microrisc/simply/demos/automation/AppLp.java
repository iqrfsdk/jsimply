 ...
 */
package com.microrisc.simply.demos.automation;

import com.microrisc.simply.demos.automation.async.AsyncDataForMqtt;
import com.microrisc.simply.demos.automation.async.AsyncDataForMqttCreator;
import com.microrisc.simply.demos.automation.async.AsyncDataForMqttCreatorException;
import com.microrisc.simply.demos.automation.config.ApplicationConfiguration;
import com.microrisc.simply.demos.automation.config.DeviceInfo;
import com.microrisc.simply.demos.automation.dpa.DPA_Result;
import com.microrisc.simply.demos.automation.mqtt.MqttCommunicator;
import com.microrisc.simply.demos.automation.mqtt.MqttConfiguration;
import com.microrisc.simply.demos.automation.mqtt.MqttFormatter;
import com.microrisc.simply.demos.automation.mqtt.MqttTopics;
    ...
    private static class DPA_IncommingAsyncMessagesListener
        ...
        public void onAsynchronousMessage(DPA_AsynchronousMessage message) {
            ...
            synchronized (synchroNewAsyncMessage) {
                AppLp.asynchronousMessages.add(message);
