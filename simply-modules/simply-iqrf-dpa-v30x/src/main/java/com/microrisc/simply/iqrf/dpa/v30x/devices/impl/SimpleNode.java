...
import com.microrisc.simply.iqrf.dpa.v30x.di_services.method_id_transformers.NodeStandardTransformer;
import com.microrisc.simply.iqrf.dpa.v30x.types.NodeStatusInfo;
...
extends DPA_DeviceObject implements Node {
    ...
    /** Network data length. */
    public static final int NETWORK_DATA_LENGTH = 49;
