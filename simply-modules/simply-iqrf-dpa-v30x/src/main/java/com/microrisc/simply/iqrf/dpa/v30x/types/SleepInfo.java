...
public final class SleepInfo {
     ...
     * bit 5 - iqrfDeepSleep() instead of iqrfSleep() is used. See IQRF OS 
    ...
    public static enum ControlBits {
        WAKEUP_ON_PORTB4_NEGATIVE_EDGE_CHANGE   (0b000001),
    ...
    *                           edge change. See iqrfSleep() method for more information.
    * @param use32msUnit If set then unit 32.768 ms instead of default 2.097 s 
    *                    (i.e. 2048 × 1.024 ms) is used.
    * @param useDeepSleep iqrfDeepSleep() instead of iqrfSleep() is used. See IQRF OS 
     *                    documentation for more information.
    * @throws IllegalArgumentException if: <br>
