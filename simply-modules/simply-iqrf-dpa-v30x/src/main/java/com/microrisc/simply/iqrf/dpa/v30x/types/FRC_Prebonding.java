...
/**
 * FRC_Prebonding command.
 *
 * @author Michal Konopa
 */
public final class FRC_Prebonding extends AbstractFRC_Command {
    ...
    public static interface Result extends FRC_CollectedBits {
        ...
        /**
         * @return {@code true} if a node provided pre-bonding to a new node
         * <br> {@code false} otherwise
         */
        boolean providedPrebondingForNewNode();
    }
    ...
    private static class ResultImpl implements Result {
        ...
        @Override
        public boolean providedPrebondingForNewNode() {
            return (bit1 == 1);
        }
    ...
    /**
     * Creates new object of {@code FRC_Prebonding} with specified user data.
     *
     ...
     * constructor.
     */
    public FRC_Prebonding(short[] userData) {
        super(userData);
    }

    /**
     * Creates new object of {@code FRC_Prebonding} with default user data. See
     ...
     * constructor.
     */
    public FRC_Prebonding(short[] userData, Node[] selectedNodes) {
        super(userData, selectedNodes);
    }

    /**
     * Creates new object of {@code FRC_Prebonding} with default
     * user data. See the
     ...
     * @param selectedNodes node on which will be command processed
     */
    public FRC_Prebonding(Node[] selectedNodes) {
        super(selectedNodes);
    }
