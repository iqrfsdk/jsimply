...
import com.microrisc.simply.iqrf.dpa.v22x.types.DPA_Parameter.DPA_ValueType;
import java.io.File;
...
public class SetDPAParams {
    ...
    public static void main(String[] args) {
        ...
        // setting DPA parameters
        DPA_Parameter dpaParameter = new DPA_Parameter(DPA_ValueType.GET_SUPPLY_VOLTAGE, false, true);
        DPA_Parameter dpaParameterPrevious = coordinator.setDPA_Param(dpaParameter);
        if ( dpaParameterPrevious == null ) {            
            ...
            if ( procState == CallRequestProcessingState.ERROR ) {
                ...
                printMessageAndExit("Setting DPA parameters failed: " + error);
            } else {
                printMessageAndExit("Setting DPA parameters hasn't been processed yet: " + procState);
            }
        }
