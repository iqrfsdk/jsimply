...
import com.microrisc.simply.iqrf.dpa.v30x.devices.SPI;
import com.microrisc.simply.iqrf.dpa.v30x.devices.Thermometer;
import com.microrisc.simply.iqrf.dpa.v30x.devices.UART;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.AddressingInfoConvertor;
...
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.BondedNodesConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.DPA_AdditionalInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.DPA_ParameterConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.DiscoveredNodesConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.DiscoveryParamsConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.DiscoveryResultConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.FRC_CommandConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.FRC_ConfigurationConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.FRC_DataConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.FRC_SelectCommandConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.HWP_ConfigurationByteConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.HWP_ConfigurationConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.LED_StateConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.LoadingCodePropertiesConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.LoadingResultConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.NodeStatusInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.OsInfoConvertor;
...
public final class DPA_StandardPerProtocolMappingFactory implements ProtocolMappingFactory {
    ...
    static private MethodToPacketMapping createSetSecurityMapping() {
        List<ConstValueToPacketMapping> constMapping = new LinkedList<>();
        constMapping.add(new ConstValueToPacketMapping(3, new short[]{0x06}));
   ...
   static private InterfaceToPacketMapping createRequestOsMapping() {
        ...
        methodMappings.put("7", createSetSecurityMapping());
        methodMappings.put("8", createRestartMapping());
        methodMappings.put("9", createWriteHWPConfigurationMapping());
        methodMappings.put("10", createWriteHWPConfigurationByteMapping());
        methodMappings.put("11", createLoadCode());
    ...
    static private PacketToInterfaceMapping createResponseEEEPROMMapping() {
        ...
        methodMappings.put("1", createResponseEEEPROMExtendedRead());
        methodMappings.put("2", createResponseEEEPROMExtendedWrite());
