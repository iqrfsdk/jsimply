...
import com.microrisc.simply.iqrf.dpa.v30x.typeconvertors.MemoryRequestConvertor;
import com.microrisc.simply.typeconvertors.ValueConversionException;
import java.util.HashMap;
import java.util.Map;

/**
 * FRC_MemoryReadPlus1 provides collecting bytes. Resulting byte is read from
 * the specified memory address after provided DPA Request is executed. This
 * allows getting one byte from any memory location (RAM, EEPROM and EEEPROM
 * peripherals, Flash, MCU register, etc.). <br>
 * Different from {@link FRC_MemoryRead} is added 1 to the returned byte in
 * order to prevent returning 0. This means that this FRC command cannot return
 * 0xFF value. <br>
 * Batch request is not allowed to be a DPA request being executed.
 *
 * @author Martin Strouhal
 */
public final class FRC_MemoryReadPlus1 extends AbstractFRC_Command {

    private static final int id = 0x83;
    ...
    private static class ResultImpl implements Result {
        ...
        /**
         * Return processed memory value without added 1 (to preventing zero
         * values)
         *
         * @return memory value
         */
    ...
    /**
     * Creates new object of {@code FRC_MemoryRead}.
     *
     ...
     * data
     */
    public FRC_MemoryReadPlus1(MemoryRequest memoryRequest) {
        super();
        try {
    ...
    /**
     * Creates new object of {@code FRC_MemoryReadPlus1}. See the
     ...
     * data
     */
    public FRC_MemoryReadPlus1(MemoryRequest memoryRequest, Node[] selectedNodes) {
        super(selectedNodes);
        try {
            this.userData = MemoryRequestConvertor.getInstance().toProtoValue(checkMemoryRequest(memoryRequest));
        } catch (ValueConversionException e) {
