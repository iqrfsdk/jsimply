 ...
 */
package com.microrisc.simply.iqrf.dpa.v30x.autonetwork.embedded.def;

import com.microrisc.simply.iqrf.dpa.v30x.autonetwork.embedded.logic.NodeApprover;
...
public enum ValueProperties {
    ...
    private ValueProperties(Class<?> dataType, int bytePos, int bitPos) {
