 ...
 */
package com.microrisc.simply.iqrf.dpa.v30x.devices;

import com.microrisc.simply.DeviceInterface;
import com.microrisc.simply.DeviceInterfaceMethodId;
import com.microrisc.simply.di_services.GenericAsyncCallable;
import com.microrisc.simply.di_services.MethodIdTransformer;
import com.microrisc.simply.iqrf.dpa.v30x.di_services.DPA_StandardServices;
...
public interface OS
   ...
   /**
    * Sends method call request for setting various security parameters.
    *
    * @param type access password or use key
    * @param data 16B long data
    * @return {@code VoidType} object, if method call has processed allright
    */
   UUID async_setSecurity(int type, short[] data);
    ...
    * into module memory.
    *
    * @param configByte config bytes to write
    * @return unique identifier of sent request
    */
   ...
   /**
    * Synchronous wrapper for {@link #async_setSecurity() async_setSecurity} method.
    *
    * @param type access password or use key
    * @param data 16B long data
    * @return {@code VoidType} object, if method call has processed allright
    */
   VoidType setSecurity(int type, short[] data);
