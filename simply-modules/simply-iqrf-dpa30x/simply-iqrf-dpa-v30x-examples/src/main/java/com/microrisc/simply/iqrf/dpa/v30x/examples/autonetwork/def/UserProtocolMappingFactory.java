...
package com.microrisc.simply.iqrf.dpa.v30x.examples.autonetwork.def;
...
public class UserProtocolMappingFactory implements ProtocolMappingFactory  {
    ...
    public ProtocolMapping createProtocolMapping() throws Exception {
        ...
        protocolMapping = new SimpleProtocolMapping( 
                callRequestToPacketMapping, packetToCallResponseMapping
        );
        return protocolMapping;
    }
}
