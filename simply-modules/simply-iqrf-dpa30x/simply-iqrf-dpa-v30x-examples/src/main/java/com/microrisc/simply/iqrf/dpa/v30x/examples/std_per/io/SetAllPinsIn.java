...
package com.microrisc.simply.iqrf.dpa.v30x.examples.std_per.io;
...
import com.microrisc.simply.iqrf.dpa.v30x.types.IO_DirectionSettings;
...
public class SetAllPinsIn {
    ...
    public static void main(String[] args) {
        ...
        IO_DirectionSettings[] dirSettings = new IO_DirectionSettings[] {
            new IO_DirectionSettings(0x00, 0x21, 0x21),
            new IO_DirectionSettings(0x01, 0x10, 0x10),
            new IO_DirectionSettings(0x02, 0xFC, 0xFC)
        };
        ...
        if (result == null) {
            ...
            if ( procState == CallRequestProcessingState.ERROR ) {
                ...
                printMessageAndExit("Setting IO direction hasn't been processed yet: " + procState);
            } 
        }
